...
public class jiaoXueTestng {
	static Logger  logger=Logger.getLogger(jiaoXueTestng.class);
  ...
  public void login() {
		...
		//driver.get("http://mvw-yth2.oss-cn-beijing.aliyuncs.com/login.html");
	...
	public void AddHuo() throws Exception{
		...
		//活动开始、
		js.executeScript("arguments[0].value=\"2018-6-6 15:15:20\"" ,driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[1]/div[2]/form/div[12]/div[1]/div/div[1]/input")));
		//结束时间
		js.executeScript("arguments[0].value=\"2018-6-6 17:15:20\"" ,driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[1]/div[2]/form/div[12]/div[1]/div/div[2]/input")));
